...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.01896167743; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.95160460328; // Multiplier in the Y direction
